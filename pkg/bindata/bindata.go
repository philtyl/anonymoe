...
var _confVersion = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x32\xd0\x33\xd4\x33\x00\x04\x00\x00\xff\xff\xb1\x21\x99\x2f\x05\x00\x00\x00")
...
func confVersion() (*asset, error) {
	...
	info := bindataFileInfo{name: "conf/VERSION", size: 5, mode: os.FileMode(420), modTime: time.Unix(1566421375, 0)}
